...
#define CS4_RA7_HIGH LATA     |= 0x80 //b'10000000'; // RA7    - /CS for SPI
#define DACCLK_RB6_HIGH LATB  |= 0x40 //b'01000000'; // RB6    - SPI CLK to VCA/Mix board
#define SPIDATA_RB7_HIGH LATB |= 0x80 //b'10000000'; // RB7    - SPI DAT to VCA/Mix board 
#define CS4_RA7_LOW LATA     &= 0x7F //b'01111111';  // RA7    - /CS for SPI
#define DACCLK_RB6_LOW LATB  &= 0xBF //b'10111111';  // RB6    - SPI CLK to VCA/Mix board
#define SPIDATA_RB7_LOW LATB &= 0x7F //b'01111111';  // RB7    - SPI DAT to VCA/Mix board 
